...
Clase para cargas útiles que representan grandes números.

**`param`** acepta una cadena de buffer, BN o base64
...
* [carga útil](utils_payload.bignumpayload.md#protected-payload)
* [typeid](utils_payload.bignumpayload.md#protected-typeid)

### Métodos de trabajo

* [deBuffer](utils_payload.bignumpayload.md#frombuffer)
* [getContent](utils_payload.bignumpayload.md#getcontent)
* [getPayload](utils_payload.bignumpayload.md#getpayload)
* [retorno.](utils_payload.bignumpayload.md#returntype)
...
\+ **nuevo BIGNUMPayload(payload:**`` útil: cualquier): *[BIGNUMPayload](utils_payload.bignumpayload.md)*

*Desgravaciones [PayloadBase](utils_payload.payloadbase.md).[constructor](utils_payload.payloadbase.md#constructor)*

*Definido en [src/utils/payload.ts:377](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L377)*

**Parámetros:**

| Nombre del nombre de la empresa | Tipo de cambio | Prejudicial | Descripción |
------ | ------ | ------ | ------ |
| `carga útil` | cualquier otra cosa que no sea | no definido. | Buffer, BN o base64 cadena |

**Retornos:** *[BIGNUMPayload](utils_payload.bignumpayload.md)*
...
*Definido en [src/utils/payload.ts:370](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L370)*
...
*Definido en [src/utils/payload.ts:375](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L375)*

Devuelve un [BN](https://github.com/indutny/bn.js/) para la carga útil.
