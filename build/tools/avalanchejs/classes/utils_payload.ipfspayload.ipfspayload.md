...
Clase para cargas útiles que representan direcciones IPFS.
...
* [carga útil](utils_payload.ipfspayload.md#protected-payload)
* [typeid](utils_payload.ipfspayload.md#protected-typeid)

### Métodos de trabajo

* [deBuffer](utils_payload.ipfspayload.md#frombuffer)
* [getContent](utils_payload.ipfspayload.md#getcontent)
* [getPayload](utils_payload.ipfspayload.md#getpayload)
* [retorno.](utils_payload.ipfspayload.md#returntype)
...
\+ **nuevo IPFSPayload(payload:**`` útil): *[IPFSPayload(payload:](utils_payload.ipfspayload.md)*
...
**Retornos:** *[IPFSPayload](utils_payload.ipfspayload.md)*
...
*Definido en [src/utils/payload.ts:635](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L635)*
