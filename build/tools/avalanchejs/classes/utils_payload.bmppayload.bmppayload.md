...
Clase para cargas útiles que representan imágenes BMP.
...
* [carga útil](utils_payload.bmppayload.md#protected-payload)
* [typeid](utils_payload.bmppayload.md#protected-typeid)

### Métodos de trabajo

* [deBuffer](utils_payload.bmppayload.md#frombuffer)
* [getContent](utils_payload.bmppayload.md#getcontent)
* [getPayload](utils_payload.bmppayload.md#getpayload)
* [retorno.](utils_payload.bmppayload.md#returntype)
...
\+ **nuevo BMPPayload(payload:**`` útil): *[BMPPayload](utils_payload.bmppayload.md)*
...
**Retornos:** *[BMPPayload](utils_payload.bmppayload.md)*
...
*Definido en [src/utils/payload.ts:560](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L560)*
