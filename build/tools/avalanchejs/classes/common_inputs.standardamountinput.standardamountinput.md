[avalancha](../README.md) › [Insumos comunes](../modules/common_inputs.md) › Entrada [StandardAmountInput](common_inputs.standardamountinput.md)

# Clase: Importe estándar

Una clase [de entrada](common_inputs.input.md) que especifica una cantidad de tokken.
...
* [importe de la cantidad de dinero](common_inputs.standardamountinput.md#protected-amount)
...
* [clon](common_inputs.standardamountinput.md#abstract-clone)
* [crear un entorno de creación](common_inputs.standardamountinput.md#abstract-create)
* [deserie](common_inputs.standardamountinput.md#deserialize)
* [deBuffer](common_inputs.standardamountinput.md#frombuffer)
...
* [seleccionar](common_inputs.standardamountinput.md#abstract-select)
* [serializar](common_inputs.standardamountinput.md#serialize)
* [toBuffer](common_inputs.standardamountinput.md#tobuffer)
* [toString](common_inputs.standardamountinput.md#tostring)
* [comparador](common_inputs.standardamountinput.md#static-comparator)

## Constructores

### constructor

\+ **nuevo StandardAmountInput(amount: (cantidad:**`` BN): *[Importe](common_inputs.standardamountinput.md)* StandardAmountInput(amount:
...
**Retornos:** *[Importe estándar](common_inputs.standardamountinput.md)*
...
*Supera [Input](common_inputs.input.md).[_typeID](common_inputs.input.md#protected-_typeid)*

*Definido en [src/comm/input.ts:270](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/input.ts#L270)*
...
*Supera [Input](common_inputs.input.md).[_typeName](common_inputs.input.md#protected-_typename)*

*Definido en [src/comm/input.ts:269](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/input.ts#L269)*
...
*Heredado de [Input](common_inputs.input.md).[select](common_inputs.input.md#abstract-select)*
