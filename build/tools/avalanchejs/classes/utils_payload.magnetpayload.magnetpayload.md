...
Clase para cargas útiles que representan los enlaces de imán torrent.

## Jerarquía

[m. UTF8Carga útil](utils_payload.utf8payload.md)

m. **MAGNETPayload** de pago
...
* [carga útil](utils_payload.magnetpayload.md#protected-payload)
* [typeid](utils_payload.magnetpayload.md#protected-typeid)

### Métodos de trabajo

* [deBuffer](utils_payload.magnetpayload.md#frombuffer)
* [getContent](utils_payload.magnetpayload.md#getcontent)
* [getPayload](utils_payload.magnetpayload.md#getpayload)
* [retorno.](utils_payload.magnetpayload.md#returntype)
...
\+ **nuevo** *[MAGNETPayload(payload): MAGNETPayload](utils_payload.magnetpayload.md)*``
...
*Definido en [src/utils/payload.ts:649](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L649)*
