[avalanche](../README.md) › [Utils-Payload](../modules/utils_payload.md) › [YAMLPayload](utils_payload.yamlpayload.md)

# Clase: YAMLPayload

Clase para cargas útiles que representan las definiciones de YAML.
...
* [carga útil](utils_payload.yamlpayload.md#protected-payload)
* [typeid](utils_payload.yamlpayload.md#protected-typeid)

### Métodos de trabajo

* [deBuffer](utils_payload.yamlpayload.md#frombuffer)
* [getContent](utils_payload.yamlpayload.md#getcontent)
* [getPayload](utils_payload.yamlpayload.md#getpayload)
* [retorno.](utils_payload.yamlpayload.md#returntype)
...
\+ **nuevo YAMLPayload(payload:**`` útil): *[YAMLPayload](utils_payload.yamlpayload.md)*
...
**Retornos:** *[YAMLPayload](utils_payload.yamlpayload.md)*
...
*Definido en [src/utils/payload.ts:614](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L614)*
