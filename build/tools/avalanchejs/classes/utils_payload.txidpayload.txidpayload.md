[avalanche](../README.md) › [Utils-Payload](../modules/utils_payload.md) › [TXIDPayload](utils_payload.txidpayload.md)

# Clase: TXIDPayload

Clase para cargas útiles que representan TxIDs.
...
* [carga útil](utils_payload.txidpayload.md#protected-payload)
* [typeid](utils_payload.txidpayload.md#protected-typeid)

### Métodos de trabajo

* [deBuffer](utils_payload.txidpayload.md#frombuffer)
* [getContent](utils_payload.txidpayload.md#getcontent)
* [getPayload](utils_payload.txidpayload.md#getpayload)
* [retorno.](utils_payload.txidpayload.md#returntype)
...
\+ **nuevo TXIDPayload(payload:**`` útil: cualquier): *[TXIDPayload](utils_payload.txidpayload.md)*
...
*Definido en [src/utils/payload.ts:484](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L484)*
