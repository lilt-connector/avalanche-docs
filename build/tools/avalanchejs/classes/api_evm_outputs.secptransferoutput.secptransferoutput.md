[avalanche](../README.md) › Productos [API-EVM-Outputs](../modules/api_evm_outputs.md) [SECPTransferOutput](api_evm_outputs.secptransferoutput.md)
...
* [direcciones](api_evm_outputs.secptransferoutput.md#protected-addresses)
* [importe de la cantidad de dinero](api_evm_outputs.secptransferoutput.md#protected-amount)
* [amountValue](api_evm_outputs.secptransferoutput.md#protected-amountvalue)
* [Tiempo de bloqueo](api_evm_outputs.secptransferoutput.md#protected-locktime)
* [numaddrs](api_evm_outputs.secptransferoutput.md#protected-numaddrs)
* [umbral](api_evm_outputs.secptransferoutput.md#protected-threshold)

### Métodos de trabajo

* [clon](api_evm_outputs.secptransferoutput.md#clone)
* [crear un entorno de creación](api_evm_outputs.secptransferoutput.md#create)
* [deserie](api_evm_outputs.secptransferoutput.md#deserialize)
* [deBuffer](api_evm_outputs.secptransferoutput.md#frombuffer)
...
* [Transferible](api_evm_outputs.secptransferoutput.md#maketransferable)
* [MeetsThreshold](api_evm_outputs.secptransferoutput.md#meetsthreshold)
* [seleccionar](api_evm_outputs.secptransferoutput.md#select)
* [serializar](api_evm_outputs.secptransferoutput.md#serialize)
* [toBuffer](api_evm_outputs.secptransferoutput.md#tobuffer)
* [toString](api_evm_outputs.secptransferoutput.md#tostring)
* [comparador](api_evm_outputs.secptransferoutput.md#static-comparator)

## Constructores

### constructor

\+ **nueva SECPTransferOutput (cantidad:**`` BN, `direcciones`: []Buffer, `tiempo de` bloqueo: BN, `umbral`: número): *[SECPTransferOutput](api_evm_outputs.secptransferoutput.md)*
...
**Retornos:** *[SECPTransferOutput](api_evm_outputs.secptransferoutput.md)*
...
• **_typeID**: *número* = EVMConstants.SECPXFEROUTPUTID

*Resources [AmountOutput](api_evm_outputs.amountoutput.md).[_typeID](api_evm_outputs.amountoutput.md#protected-_typeid)*

*Definido en [src/apis/evm/outputs.ts:76](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/evm/outputs.ts#L76)*
...
*Resources [AmountOutput](api_evm_outputs.amountoutput.md).[_typeName](api_evm_outputs.amountoutput.md#protected-_typename)*

*Definido en [src/apis/evm/outputs.ts:75](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/evm/outputs.ts#L75)*
...
*Definido en [src/apis/evm/outputs.ts:91](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/evm/outputs.ts#L91)*
...
*Definido en [src/apis/evm/outputs.ts:87](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/evm/outputs.ts#L87)*
...
*Definido en [src/apis/evm/outputs.ts:83](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/evm/outputs.ts#L83)*
...
- Transferible **makeTransferable**(`assetID`: Buffer): *[Producto transferible](api_evm_outputs.transferableoutput.md)*

*Heredado de [AmountOutput](api_evm_outputs.amountoutput.md).[makeTransferable](api_evm_outputs.amountoutput.md#maketransferable)*

*Supera [Output](common_output.output.md).[makeTransferable](common_output.output.md#abstract-maketransferable)*

*Definido en [src/apis/evm/outputs.ts:62](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/evm/outputs.ts#L62)*
...
*Heredado de la [AmountOutput](api_evm_outputs.amountoutput.md).[select](api_evm_outputs.amountoutput.md#select)*

*Supera la [Output](common_output.output.md).[select](common_output.output.md#abstract-select)*

*Definido en [src/apis/evm/outputs.ts:66](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/evm/outputs.ts#L66)*
