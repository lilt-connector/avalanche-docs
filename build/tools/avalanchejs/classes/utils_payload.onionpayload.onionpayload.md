...
Clase para cargas útiles que representan las URLs de cebolla.
...
* [carga útil](utils_payload.onionpayload.md#protected-payload)
* [typeid](utils_payload.onionpayload.md#protected-typeid)

### Métodos de trabajo

* [deBuffer](utils_payload.onionpayload.md#frombuffer)
* [getContent](utils_payload.onionpayload.md#getcontent)
* [getPayload](utils_payload.onionpayload.md#getpayload)
* [retorno.](utils_payload.onionpayload.md#returntype)
...
\+ **nuevo ONIONPayload(payload:**`` útil): *[ONIONPayload(payload:](utils_payload.onionpayload.md)*
...
**Retornos:** *[ONIONPayload](utils_payload.onionpayload.md)*
...
*Definido en [src/utils/payload.ts:642](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L642)*
