...
# Clase: CHAINIDPayload

Clase para cargas útiles que representan a ChainIDs.
...
* [carga útil](utils_payload.chainidpayload.md#protected-payload)
* [typeid](utils_payload.chainidpayload.md#protected-typeid)

### Métodos de trabajo

* [deBuffer](utils_payload.chainidpayload.md#frombuffer)
* [getContent](utils_payload.chainidpayload.md#getcontent)
* [getPayload](utils_payload.chainidpayload.md#getpayload)
* [retorno.](utils_payload.chainidpayload.md#returntype)
...
\+ **nuevo** CHAINIDPayload(`payload`: útil): *[CHAINIDPayload](utils_payload.chainidpayload.md)*
...
*Definido en [src/utils/payload.ts:519](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L519)*
