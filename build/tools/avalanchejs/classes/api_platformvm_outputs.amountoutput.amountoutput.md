[avalanche](../README.md) › Productos [API-PlatformVM-Outputs](../modules/api_platformvm_outputs.md) › [Salida de cantidad](api_platformvm_outputs.amountoutput.md)
...
de la salida [SECPTransferOutput](api_platformvm_outputs.secptransferoutput.md)

de [las partes interesadas LockOut](api_platformvm_outputs.stakeablelockout.md)
...
* [direcciones](api_platformvm_outputs.amountoutput.md#protected-addresses)
* [importe de la cantidad de dinero](api_platformvm_outputs.amountoutput.md#protected-amount)
* [amountValue](api_platformvm_outputs.amountoutput.md#protected-amountvalue)
* [Tiempo de bloqueo](api_platformvm_outputs.amountoutput.md#protected-locktime)
* [numaddrs](api_platformvm_outputs.amountoutput.md#protected-numaddrs)
* [umbral](api_platformvm_outputs.amountoutput.md#protected-threshold)

### Métodos de trabajo

* [clon](api_platformvm_outputs.amountoutput.md#abstract-clone)
* [crear un entorno de creación](api_platformvm_outputs.amountoutput.md#abstract-create)
* [deserie](api_platformvm_outputs.amountoutput.md#deserialize)
* [deBuffer](api_platformvm_outputs.amountoutput.md#frombuffer)
...
* [Transferible](api_platformvm_outputs.amountoutput.md#maketransferable)
* [MeetsThreshold](api_platformvm_outputs.amountoutput.md#meetsthreshold)
* [seleccionar](api_platformvm_outputs.amountoutput.md#select)
* [serializar](api_platformvm_outputs.amountoutput.md#serialize)
* [toBuffer](api_platformvm_outputs.amountoutput.md#tobuffer)
* [toString](api_platformvm_outputs.amountoutput.md#tostring)
* [comparador](api_platformvm_outputs.amountoutput.md#static-comparator)

## Constructores

### constructor

\+ **nueva** `AmountOutput(amount`*[:](api_platformvm_outputs.amountoutput.md)* BN, `direcciones`: []Buffer, `tiempo de` bloqueo: BN, `umbral`: número): AmountOutput(amount:
...
**Retornos:** *[Producto de](api_platformvm_outputs.amountoutput.md)* Cantidad:
...
*Definido en [src/apis/platformvm/outputs.ts:79](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/platformvm/outputs.ts#L79)*
...
*Definido en [src/apis/platformvm/outputs.ts:78](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/platformvm/outputs.ts#L78)*
