[avalancha](../README.md) › [src/utils](../modules/src_utils.md) › [EVMFeeError](src_utils.evmfeeerror.md)
...
* [mensaje](src_utils.evmfeeerror.md#message)
* [Nombre del nombre](src_utils.evmfeeerror.md#name)
* [pila](src_utils.evmfeeerror.md#optional-stack)
...
\+ **nuevo EVMFeeError(m:**`` string): *[EVMFeeError](src_utils.evmfeeerror.md)*

*Overrides [AvalancheError](src_utils.avalancheerror.md).[constructor](src_utils.avalancheerror.md#constructor)*

*Definido en [src/utils/errores.ts:329](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/errors.ts#L329)*
...
**Return:** *[EVMFeeError](src_utils.evmfeeerror.md)*
