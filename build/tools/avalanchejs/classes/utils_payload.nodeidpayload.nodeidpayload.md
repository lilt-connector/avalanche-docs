...
* [carga útil](utils_payload.nodeidpayload.md#protected-payload)
* [typeid](utils_payload.nodeidpayload.md#protected-typeid)

### Métodos de trabajo

* [deBuffer](utils_payload.nodeidpayload.md#frombuffer)
* [getContent](utils_payload.nodeidpayload.md#getcontent)
* [getPayload](utils_payload.nodeidpayload.md#getpayload)
* [retorno.](utils_payload.nodeidpayload.md#returntype)
...
\+ **nuevo** NODEIDPayload(`payload`: útil: cualquier): *[NODEIDPayload](utils_payload.nodeidpayload.md)*
...
*Definido en [src/utils/payload.ts:526](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L526)*
