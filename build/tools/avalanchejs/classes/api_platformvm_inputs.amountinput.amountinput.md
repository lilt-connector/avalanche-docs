[avalanche](../README.md) › Insumos [API-PlatformVM-Inputs](../modules/api_platformvm_inputs.md) › [AmountInput](api_platformvm_inputs.amountinput.md)
...
de la [SECPTransferInput](api_platformvm_inputs.secptransferinput.md)

m [StakeableLockIn](api_platformvm_inputs.stakeablelockin.md)
...
* [importe de la cantidad de dinero](api_platformvm_inputs.amountinput.md#protected-amount)
...
* [clon](api_platformvm_inputs.amountinput.md#abstract-clone)
* [crear un entorno de creación](api_platformvm_inputs.amountinput.md#abstract-create)
* [deserie](api_platformvm_inputs.amountinput.md#deserialize)
* [deBuffer](api_platformvm_inputs.amountinput.md#frombuffer)
...
* [seleccionar](api_platformvm_inputs.amountinput.md#select)
* [serializar](api_platformvm_inputs.amountinput.md#serialize)
* [toBuffer](api_platformvm_inputs.amountinput.md#tobuffer)
* [toString](api_platformvm_inputs.amountinput.md#tostring)
* [comparador](api_platformvm_inputs.amountinput.md#static-comparator)

## Constructores

### constructor

\+ **nueva** *[AmountInput](api_platformvm_inputs.amountinput.md)*(`amount`: BN): Importe de entrada
...
**Retornos:** *[Importe](api_platformvm_inputs.amountinput.md)*
...
*Definido en [src/apis/platformvm/inputs.ts:92](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/platformvm/inputs.ts#L92)*
...
*Definido en [src/apis/platformvm/inputs.ts:91](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/platformvm/inputs.ts#L91)*
