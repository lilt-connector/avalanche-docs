[avalanche](../README.md) › Productos [API-EVM-Outputs](../modules/api_evm_outputs.md) › [Salida de cantidad](api_evm_outputs.amountoutput.md)
...
de la salida [SECPTransferOutput](api_evm_outputs.secptransferoutput.md)
...
* [direcciones](api_evm_outputs.amountoutput.md#protected-addresses)
* [importe de la cantidad de dinero](api_evm_outputs.amountoutput.md#protected-amount)
* [amountValue](api_evm_outputs.amountoutput.md#protected-amountvalue)
* [Tiempo de bloqueo](api_evm_outputs.amountoutput.md#protected-locktime)
* [numaddrs](api_evm_outputs.amountoutput.md#protected-numaddrs)
* [umbral](api_evm_outputs.amountoutput.md#protected-threshold)

### Métodos de trabajo

* [clon](api_evm_outputs.amountoutput.md#abstract-clone)
* [crear un entorno de creación](api_evm_outputs.amountoutput.md#abstract-create)
* [deserie](api_evm_outputs.amountoutput.md#deserialize)
* [deBuffer](api_evm_outputs.amountoutput.md#frombuffer)
...
* [Transferible](api_evm_outputs.amountoutput.md#maketransferable)
* [MeetsThreshold](api_evm_outputs.amountoutput.md#meetsthreshold)
* [seleccionar](api_evm_outputs.amountoutput.md#select)
* [serializar](api_evm_outputs.amountoutput.md#serialize)
* [toBuffer](api_evm_outputs.amountoutput.md#tobuffer)
* [toString](api_evm_outputs.amountoutput.md#tostring)
* [comparador](api_evm_outputs.amountoutput.md#static-comparator)

## Constructores

### constructor

\+ **nueva** `AmountOutput(amount`*[:](api_evm_outputs.amountoutput.md)* BN, `direcciones`: []Buffer, `tiempo de` bloqueo: BN, `umbral`: número): AmountOutput(amount:
...
**Retornos:** *[Producto de](api_evm_outputs.amountoutput.md)* Cantidad:
...
*Definido en [src/apis/evm/outputs.ts:54](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/evm/outputs.ts#L54)*
...
*Definido en [src/apis/evm/outputs.ts:53](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/evm/outputs.ts#L53)*
