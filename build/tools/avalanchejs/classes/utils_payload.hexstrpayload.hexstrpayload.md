...
Clase para cargas útiles que representan el codificación Hexadecimal.
...
* [carga útil](utils_payload.hexstrpayload.md#protected-payload)
* [typeid](utils_payload.hexstrpayload.md#protected-typeid)

### Métodos de trabajo

* [deBuffer](utils_payload.hexstrpayload.md#frombuffer)
* [getContent](utils_payload.hexstrpayload.md#getcontent)
* [getPayload](utils_payload.hexstrpayload.md#getpayload)
* [retorno.](utils_payload.hexstrpayload.md#returntype)
...
\+ **nuevo** *[HEXSTRPayload](utils_payload.hexstrpayload.md)*(`payload`: útil: cualquiera

*Desgravaciones [PayloadBase](utils_payload.payloadbase.md).[constructor](utils_payload.payloadbase.md#constructor)*

*Definido en [src/utils/payload.ts:297](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L297)*

**Parámetros:**

| Nombre del nombre de la empresa | Tipo de cambio | Prejudicial | Descripción |
------ | ------ | ------ | ------ |
| `carga útil` | cualquier otra cosa que no sea | no definido. | Corriente de amortiguación o hex |

**Retornos:** *[HEXSTRPayload](utils_payload.hexstrpayload.md)*
...
*Definido en [src/utils/payload.ts:290](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L290)*
...
*Definido en [src/utils/payload.ts:295](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/utils/payload.ts#L295)*

Devuelve una cadena hex para la carga útil.
